  ...
  <cfoutput>
						...
						<table width="661" cellspacing="2" cellpadding="2" bgcolor="##0091B5">
							<tr>
							  	<td>
									<center>
										<div style="width:20px; height: 20px; background-color: ##ff6600; border: 1px solid ##000000; text-align: center;">
											<a href="calendarWizard.cfm?z=#Encrypt(Encrypt(ARGUMENTS.ucid,fishkey,'BLOWFISH','BASE64'),fishkey,'BLOWFISH','HEX')#&d=#DateFormat(DateAdd('m',-1,iDate),'yyyy-mm-dd')#" style="color: ##ffffff; font-weight: bold; text-decoration: none; font-size: 14pt;">
												&lt;
											</a>
										</div>
									</center>	
