<cfcomponent>
<cffunction name="largeCalendar" access="public" returntype="string" output="true">
  ...
  <cfoutput>
    ...
    <tr>
      <td><center>
          <div style="width:20px; height: 20px; background-color: ##ff6600; border: 1px solid ##000000; text-align: center;"> <a href="calendarWizard.cfm?z=#Encrypt(Encrypt(ARGUMENTS.ucid,fishkey,'BLOWFISH','BASE64'),fishkey,'BLOWFISH','HEX')#&d=#DateFormat(DateAdd('m',-1,iDate),'yyyy-mm-dd')#" style="color: ##ffffff; font-weight: bold; text-decoration: none; font-size: 14pt;"> &lt; </a> </div>
        </center></td>
      ...
      <td style="text-align:right;"><center>
        <div style="width:20px; height: 20px; background-color: ##ff6600; border: 1px solid ##000000; text-align: center;"> <a href="calendarWizard.cfm?z=#Encrypt(Encrypt(ARGUMENTS.ucid,fishkey,'BLOWFISH','BASE64'),fishkey,'BLOWFISH','HEX')#&d=#DateFormat(DateAdd('m',1,iDate),'yyyy-mm-dd')#" style="color: ##ffffff; font-weight: bold; text-decoration: none;font-size: 14pt;"> &gt; </a> </div></td>
    </tr>
    <tr>
      <td colspan="7" height="15"></td>
    </tr>
    <tr>
      <td width="89" style="font-size:12px; font-weight: bold;" align="center">Sun</td>
      <td width="89" style="font-size:12px; font-weight: bold;" align="center">Mon</td>
      <td width="89" style="font-size:12px; font-weight: bold;" align="center">Tue</td>
      <td width="89" style="font-size:12px; font-weight: bold;" align="center">Wed</td>
      <td width="89" style="font-size:12px; font-weight: bold;" align="center">Thu</td>
      <td width="89" style="font-size:12px; font-weight: bold;" align="center">Fri</td>
      <td width="89" style="font-size:12px; font-weight: bold;" align="center">Sat</td>
    </tr>
    <tr>
  </cfoutput>
  <cfquery name="qGetSched" datasource="#ds#" username="#un#" password="#pw#">
						  SELECT * FROM a_categoryschedule WHERE ucid = '#ARGUMENTS.ucid#'
						  </cfquery>
  <cfquery name="qGetContent" datasource="#ds#" username="#un#" password="#pw#">
						  SELECT * FROM a_contentbase WHERE ucid = '#ARGUMENTS.ucid#'
						  </cfquery>
  <cfif begin EQ 1>
    <cfoutput>
      <cfquery name="qCheckDate" dbtype="query">
							  SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(iDate,'yyyy-mm-dd')#'
							  </cfquery>
      ...
      <td width="89" height="100" class="#class#">#DateFormat(iDate,'dd')#<br />
        ...
        <cfloop query="qGetContent">
          <cfoutput>
            <option value="#qGetContent.contentId#" <cfif qCheckDate.contentId EQ qGetContent.contentId>selected="selected"</cfif>>#qGetContent.contentId#</option>
          </cfoutput>
        </cfloop>
        </select></td>
      <cfquery name="qCheckDate" dbtype="query">
						  SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',1,iDate),'yyyy-mm-dd')#'
						  </cfquery>
      <cfif qCheckDate.RecordCount EQ 0>
        <cfset class="calAvail">
        <cfelse>
      ...
      <cfquery name="qCheckDate" dbtype="query">
						  SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',2,iDate),'yyyy-mm-dd')#'
						  </cfquery>
      <cfif qCheckDate.RecordCount EQ 0>
        <cfset class="calAvail">
        <cfelse>
      ...
      <cfquery name="qCheckDate" dbtype="query">
						  SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',3,iDate),'yyyy-mm-dd')#'
						  </cfquery>
      <cfif qCheckDate.RecordCount EQ 0>
        <cfset class="calAvail">
        <cfelse>
      ...
      <cfquery name="qCheckDate" dbtype="query">
						  SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',4,iDate),'yyyy-mm-dd')#'
						  </cfquery>
      <cfif qCheckDate.RecordCount EQ 0>
        <cfset class="calAvail">
        <cfelse>
      ...
      <cfquery name="qCheckDate" dbtype="query">
						  SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',5,iDate),'yyyy-mm-dd')#'
						  </cfquery>
      <cfif qCheckDate.RecordCount EQ 0>
        <cfset class="calAvail">
        <cfelse>
      ...
      <cfquery name="qCheckDate" dbtype="query">
						  SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',6,iDate),'yyyy-mm-dd')#'
						  </cfquery>
      <cfif qCheckDate.RecordCount EQ 0>
        <cfset class="calAvail">
        <cfelse>
  ...
  <cfoutput>
    ...
    <tr class="cal">
      <cfquery name="qCheckDate" dbtype="query">
						  SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',nn,iDate),'yyyy-mm-dd')#'
						  </cfquery>
      <cfif qCheckDate.RecordCount EQ 0>
        <cfset class="calAvail">
        <cfelse>
      ...
      <cfquery name="qCheckDate" dbtype="query">
						  SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',nn+1,iDate),'yyyy-mm-dd')#'
						  </cfquery>
      <cfif qCheckDate.RecordCount EQ 0>
        <cfset class="calAvail">
        <cfelse>
      ...
      <cfquery name="qCheckDate" dbtype="query">
						  SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',nn+2,iDate),'yyyy-mm-dd')#'
						  </cfquery>
      <cfif qCheckDate.RecordCount EQ 0>
        <cfset class="calAvail">
        <cfelse>
      ...
      <cfquery name="qCheckDate" dbtype="query">
						  SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',nn+3,iDate),'yyyy-mm-dd')#'
						  </cfquery>
      <cfif qCheckDate.RecordCount EQ 0>
        <cfset class="calAvail">
        <cfelse>
      ...
      <cfquery name="qCheckDate" dbtype="query">
						  SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',nn+4,iDate),'yyyy-mm-dd')#'
						  </cfquery>
      <cfif qCheckDate.RecordCount EQ 0>
        <cfset class="calAvail">
        <cfelse>
      ...
      <cfquery name="qCheckDate" dbtype="query">
						  SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',nn+5,iDate),'yyyy-mm-dd')#'
						  </cfquery>
      <cfif qCheckDate.RecordCount EQ 0>
        <cfset class="calAvail">
        <cfelse>
      ...
      <cfquery name="qCheckDate" dbtype="query">
						  SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',nn+6,iDate),'yyyy-mm-dd')#'
						  </cfquery>
      <cfif qCheckDate.RecordCount EQ 0>
        <cfset class="calAvail">
        <cfelse>
    ...
    <tr class="cal">
      <cfquery name="qCheckDate" dbtype="query">
						  SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',nn+7,iDate),'yyyy-mm-dd')#'
						  </cfquery>
      <cfif qCheckDate.RecordCount EQ 0>
        <cfset class="calAvail">
        <cfelse>
      ...
      <cfquery name="qCheckDate" dbtype="query">
						  SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',nn+8,iDate),'yyyy-mm-dd')#'
						  </cfquery>
      <cfif qCheckDate.RecordCount EQ 0>
        <cfset class="calAvail">
        <cfelse>
      ...
      <cfquery name="qCheckDate" dbtype="query">
						  SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',nn+9,iDate),'yyyy-mm-dd')#'
						  </cfquery>
      <cfif qCheckDate.RecordCount EQ 0>
        <cfset class="calAvail">
        <cfelse>
      ...
      <cfquery name="qCheckDate" dbtype="query">
						  SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',nn+10,iDate),'yyyy-mm-dd')#'
						  </cfquery>
      <cfif qCheckDate.RecordCount EQ 0>
        <cfset class="calAvail">
        <cfelse>
      ...
      <cfquery name="qCheckDate" dbtype="query">
						  SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',nn+11,iDate),'yyyy-mm-dd')#'
						  </cfquery>
      <cfif qCheckDate.RecordCount EQ 0>
        <cfset class="calAvail">
        <cfelse>
      ...
      <cfquery name="qCheckDate" dbtype="query">
						  SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',nn+12,iDate),'yyyy-mm-dd')#'
						  </cfquery>
      <cfif qCheckDate.RecordCount EQ 0>
        <cfset class="calAvail">
        <cfelse>
      ...
      <cfquery name="qCheckDate" dbtype="query">
						  SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',nn+13,iDate),'yyyy-mm-dd')#'
						  </cfquery>
      <cfif qCheckDate.RecordCount EQ 0>
        <cfset class="calAvail">
        <cfelse>
    ...
    <tr class="cal">
      <cfquery name="qCheckDate" dbtype="query">
						  SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',nn+14,iDate),'yyyy-mm-dd')#'
						  </cfquery>
      <cfif qCheckDate.RecordCount EQ 0>
        <cfset class="calAvail">
        <cfelse>
      ...
      <cfquery name="qCheckDate" dbtype="query">
						  SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',nn+15,iDate),'yyyy-mm-dd')#'
						  </cfquery>
      <cfif qCheckDate.RecordCount EQ 0>
        <cfset class="calAvail">
        <cfelse>
      ...
      <cfquery name="qCheckDate" dbtype="query">
						  SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',nn+16,iDate),'yyyy-mm-dd')#'
						  </cfquery>
      <cfif qCheckDate.RecordCount EQ 0>
        <cfset class="calAvail">
        <cfelse>
      ...
      <cfquery name="qCheckDate" dbtype="query">
						  SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',nn+17,iDate),'yyyy-mm-dd')#'
						  </cfquery>
      <cfif qCheckDate.RecordCount EQ 0>
        <cfset class="calAvail">
        <cfelse>
      ...
      <cfquery name="qCheckDate" dbtype="query">
						  SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',nn+18,iDate),'yyyy-mm-dd')#'
						  </cfquery>
      <cfif qCheckDate.RecordCount EQ 0>
        <cfset class="calAvail">
        <cfelse>
      ...
      <cfquery name="qCheckDate" dbtype="query">
						  SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',nn+19,iDate),'yyyy-mm-dd')#'
						  </cfquery>
      <cfif qCheckDate.RecordCount EQ 0>
        <cfset class="calAvail">
        <cfelse>
      ...
      <cfquery name="qCheckDate" dbtype="query">
						  SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',nn+20,iDate),'yyyy-mm-dd')#'
						  </cfquery>
      <cfif qCheckDate.RecordCount EQ 0>
        <cfset class="calAvail">
        <cfelse>
  ...
  <cfif begin EQ 7>
    <cfif end LT 30>
      <cfif IsLeapYear(Year(iDate))>
        <cfoutput>
          <tr class="cal">
            <cfquery name="qCheckDate" dbtype="query">
								SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',nn+21,iDate),'yyyy-mm-dd')#'
								</cfquery>
            <cfif qCheckDate.RecordCount EQ 0>
              <cfset class="calAvail">
              <cfelse>
            ...
            <cfquery name="qCheckDate" dbtype="query">
								SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',nn+22,iDate),'yyyy-mm-dd')#'
								</cfquery>
            <cfif qCheckDate.RecordCount EQ 0>
              <cfset class="calAvail">
              <cfelse>
            ...
            <cfquery name="qCheckDate" dbtype="query">
								SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',nn+23,iDate),'yyyy-mm-dd')#'
								</cfquery>
            <cfif qCheckDate.RecordCount EQ 0>
              <cfset class="calAvail">
              <cfelse>
            ...
            <cfquery name="qCheckDate" dbtype="query">
								SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',nn+24,iDate),'yyyy-mm-dd')#'
								</cfquery>
            <cfif qCheckDate.RecordCount EQ 0>
              <cfset class="calAvail">
              <cfelse>
            ...
            <cfquery name="qCheckDate" dbtype="query">
								SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',nn+25,iDate),'yyyy-mm-dd')#'
								</cfquery>
            <cfif qCheckDate.RecordCount EQ 0>
              <cfset class="calAvail">
              <cfelse>
            ...
            <cfquery name="qCheckDate" dbtype="query">
								SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',nn+26,iDate),'yyyy-mm-dd')#'
								</cfquery>
            <cfif qCheckDate.RecordCount EQ 0>
              <cfset class="calAvail">
              <cfelse>
            ...
            <cfquery name="qCheckDate" dbtype="query">
								SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',nn+27,iDate),'yyyy-mm-dd')#'
								</cfquery>
            <cfif qCheckDate.RecordCount EQ 0>
              <cfset class="calAvail">
              <cfelse>
    ...
    <cfif end EQ 30>
      <cfoutput>
        <tr class="cal">
          <cfquery name="qCheckDate" dbtype="query">
							  SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',nn+28,iDate),'yyyy-mm-dd')#'
							  </cfquery>
          <cfif qCheckDate.RecordCount EQ 0>
            <cfset class="calAvail">
            <cfelse>
      ...
      <cfoutput>
        <tr class="cal">
          ...
          <cfquery name="qCheckDate" dbtype="query">
							  SELECT runDate, contentId FROM qGetSched WHERE runDate = '#DateFormat(DateAdd('d',nn+29,iDate),'yyyy-mm-dd')#'
							  </cfquery>
          <cfif qCheckDate.RecordCount EQ 0>
            <cfset class="calAvail">
            <cfelse>
