...
<cfquery name="qDelCategory" datasource="#ds#" username="#un#" password="#pw#" cachedwithin="#CreateTimeSpan(0,0,0,30)#">
DELETE FROM a_categorybase WHERE ucid = '#ucid#'
</cfquery>
<!--- delete categories schedule --->
<cfquery name="qDelSchedule" datasource="#ds#" username="#un#" password="#pw#" cachedwithin="#CreateTimeSpan(0,0,0,30)#">
DELETE FROM a_categoryschedule WHERE ucid = '#ucid#'
</cfquery>
<!--- delete category contents --->
<cfquery name="qDelContents" datasource="#ds#" username="#un#" password="#pw#" cachedwithin="#CreateTimeSpan(0,0,0,30)#">
DELETE FROM a_categorybase WHERE ucid = '#ucid#'
</cfquery>
<!--- delete default schedule --->
<cfquery name="qDelDefSchedule" datasource="#ds#" username="#un#" password="#pw#" cachedwithin="#CreateTimeSpan(0,0,0,30)#">
