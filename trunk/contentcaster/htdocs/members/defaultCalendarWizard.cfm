...
text-align:center
 ...
 <table cellpadding="0" cellspacing="0" border="0" align="center" class="bodyTable" width="741" bgcolor="#CCCCCC">
	<tr>
		...
		<td bgcolor="##0091B5" style="padding-top:10px;">
<cfif URL.rc NEQ "">
  <span style="padding-left:40px; font-family:Verdana, Arial, Helvetica, sans-serif; font-weight:bold;"><cfoutput>#URL.rc#</cfoutput> days were modified during the last update.</span>
  <br />
  <br />
  <br />
</cfif>
    ...
    <input type="hidden" name="xDate" value="#DateFormat(URL.d,'yyyy-mm-dd')#" />
			...
			<table cellpadding="0" cellspacing="0" border="0" align="center" width="667" bgcolor="##0091B5">
				...
				<tr>
					...
					<td bgcolor="##0091B5" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:10pt; color: ##000000;">
					  <cfinvoke component="largeDefaultCalendar" method="largeDefaultCalendar" returnvariable="foo" ucid="bogus" cDate="#DateFormat(URL.d,'yyyy-mm-dd')#">
					   <cfoutput>
					  	<div style="background-color:##0091B5;">
					  <br />
					  <br />
