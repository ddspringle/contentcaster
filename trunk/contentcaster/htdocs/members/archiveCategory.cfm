  ...
  <tr>
    ...
    <td  bgcolor="#CCCCCC" style="padding-top:10px;"><table cellpadding="0" cellspacing="0" border="0" align="center" width="667">
        ...
        <tr>
          ...
          <td class="textTable" width="667"><p>Your category, <cfoutput>#Decrypt(qGetCat.categoryName,fishkey,'BLOWFISH','HEX')#</cfoutput>, has been moved to the archives. It will no longer display in the list of active categories and will no longer be capable of running on a schedule. It will be visible only from the archives section of the admin interface, user interface (if user archived) and through the website. This action is currently irreversible - all schedule data associated with this category has been removed.</p></td>
