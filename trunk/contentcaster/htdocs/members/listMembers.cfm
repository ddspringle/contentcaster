  ...
  <tr>
    ...
    <td bgcolor="#CCCCCC" style="padding-top:10px;"><table cellpadding="0" cellspacing="0" border="0" align="center" width="673">
        ...
        <tr>
          ...
          <td class="textTable" width="655"><table width="645" border="0" cellspacing="0" cellpadding="0">
              <tr>
              ...
              <cfloop query="qGetMembers">
                ...
                <tr>
                  ...
                  <td width="18"><div style="padding-left: 10px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:8pt;"><cfoutput><a href="editMember.cfm?z=#Encrypt(Encrypt(qGetMembers.uuid,fishkey,'BLOWFISH','BASE64'),fishkey,'BLOWFISH','HEX')#"><img src="../images/editIcon.gif" alt="Edit Member" border="0"/></a></cfoutput></div></td>
                  <td width="18"><div style="padding-right: 20px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:8pt;"><cfoutput><a href="dropMember.cfm?z=#Encrypt(Encrypt(qGetMembers.uuid,fishkey,'BLOWFISH','BASE64'),fishkey,'BLOWFISH','HEX')#"><img src="../images/deleteIcon.gif" border="0"/></a></cfoutput></div></td>
                </tr>
