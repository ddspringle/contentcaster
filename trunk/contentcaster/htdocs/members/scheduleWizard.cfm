  ...
  <tr>
    ...
    <td  bgcolor="#CCCCCC" style="padding-top:10px;"><table cellpadding="0" cellspacing="0" border="0" align="center" width="667">
        ...
        <tr>
          ...
          <td class="textTable" width="667"><cfif errorText NEQ "">
            ...
            <form name="scheduleCategory" method="post" action="updateSchedule.cfm">
              <cfoutput>
