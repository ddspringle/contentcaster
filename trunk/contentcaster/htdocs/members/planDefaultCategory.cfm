...
<table cellpadding="0" cellspacing="0" border="0" align="center" class="bodyTable" width="741">
  ...
  <tr>
    <td>
    <td  bgcolor="#CCCCCC" style="padding-top:10px;"></td>
  </tr>
  <table cellpadding="0" cellspacing="0" border="0" align="center" width="673">
    <tr>
      <td colspan="3"><img src="../images/scheduleAdminTitle.gif" /></td>
    </tr>
    <tr>
      <td>
    <tr></td>
    ...
    <tr>
      <td>
      <td class="textTable" width="655"></td>
    </tr>
    <table border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="left" class="calHeader">Default contentCaster Schedule</td>
      </tr>
    </table>
          ...
          <tr>
            <td valign="top"><cfoutput>
                <table width="225" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td><a href="defaultCalendarWizard.cfm"><img src="../images/calendarWizardButton.gif" border="0" alt="Calendar Wizard" /></a> </td>
                  </tr>
                </table>
              </cfoutput> </td>
          </tr>
      ...
      <table cellpadding="0" cellspacing="0" border="0">
        ...
        <cfif begin EQ 1>
          <cfoutput>
            ...
            <tr>
              <td>
              <td width="10" height="10" class="#class#"></td>
            </tr>
            #DateFormat(iDate,'dd')#
            <tr>
              <td></td>
