...
SELECT * FROM a_categoryschedule WHERE ucid = '#newZ#' AND (runDate BETWEEN #startTime# AND #endTime#)
</cfquery>
...
<cfquery name="qGetNewSched" dbtype="query">
SELECT * FROM qGetSched, qGetContent WHERE qGetSched.contentId = qGetContent.contentId
</cfquery>
<!--- HTML --->
<!--- set page <title> tag with pageName variable --->
<cfset pageName = "Plan #Decrypt(qGetCat.categoryName,fishkey,'BLOWFISH','HEX')# Content &raquo; #DateFormat(URL.d,'mmmm dd, yyyy')#">
<!--- include the header template --->
<cfinclude template="../includes/header.cfm">
<!--- BODY --->
<form action="updateContentDate.cfm" method="post" name="updateContentDate" id="updateContentDate">
  <cfoutput>
  ...
  <table cellpadding="0" cellspacing="0" border="0" class="bodyTable">
      ...
      <td style="padding-top:10px;"><table cellpadding="0" cellspacing="0" border="0" class="newUserTable">
          ...
          <tr>
            ...
            <td class="textTable"><table border="0" cellspacing="2" cellpadding="2" class="textTable">
                <tr>
                  <td class="planningTableText" colspan="2"><cfoutput>#Decrypt(qGetCat.categoryName,fishkey,'BLOWFISH','HEX')#&nbsp;&raquo;&nbsp;#DateFormat(URL.d,'mmmm dd, yyyy')#</cfoutput></td>
                </tr>
                <tr>
                  <td colspan="2">&nbsp;</td>
                </tr>
                            ...
                            <td class="planContentDateContent"><cfoutput>
                                <select name="content_#iX#">
                                  ...
                                  <cfloop query="qGetContent">
                                    <option value="#qGetContent.contentId#" <cfif qGetHourLeft.contentId EQ qGetContent.contentId>selected="selected"</cfif>>#qGetContent.contentName#</option>
                                  </cfloop>
                                </select>
                              </cfoutput></td>
                          </tr>
                          ...
                          <tr>
                            <td class="planContentDateContent"><cfoutput>
                                <select name="content_#iX+12#">
                                  <option value="0">^ Prior Content ^</option>
                                  <cfloop query="qGetContent">
                                    <option value="#qGetContent.contentId#" <cfif qGetHourRight.contentId EQ qGetContent.contentId>selected="selected"</cfif>>#qGetContent.contentName#</option>
                                  </cfloop>
                                </select>
                              </cfoutput></td>
                          </tr>
    ...
    <tr>
      <td class="bodyLeft">&nbsp;</td>
      <td class="navStyle"><cfoutput><a href="calendarWizard.cfm?z=#URL.z#&amp;d=#URL.d#"><img src="../images/calendarButton.gif" alt="Calendar Wizard" width="150" height="47" border="0" /></a></cfoutput><a href="listCategories.cfm"><img src="../images/categoryListButton.gif" alt="Category List" width="140" height="47" border="0" /></a><a href="mainMenu.cfm"><img src="../images/mainMenuButton.gif" alt="Main Menu" width="140" height="47" border="0" /></a></td>
      <td class="bodyRight">&nbsp;</td>
    </tr>
  </table>
</form>
